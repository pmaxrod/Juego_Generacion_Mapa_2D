...
/// Para crear un nuevo Algoritmo, haga clic con el botón derecho en la vista del proyecto y 
/// seleccione Configuración de la capa del mapa
...
public class ConfigurarMapa : ScriptableObject
{
    ...
    public float porcentajeRellenoFloat; // Para los algoritmos de autómatas
    public int numeroPasadas; // número de pasadas para los automatas
}
...
public class ConfigurarMapaEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        capaMapa.algoritmo = (Algoritmo)EditorGUILayout.EnumPopup(new GUIContent("Metodo a generar", "El método de generación que queremos usar para generar el mapa"), capaMapa.algoritmo);
        ...
        switch (capaMapa.algoritmo)
        {
            ...
            case Algoritmo.RANDOMWALK_SUAVIZADO:
                capaMapa.intervalo = EditorGUILayout.IntSlider("Ancho de la sección", capaMapa.intervalo, 1, 10);
                break;
            ...
            case Algoritmo.TUNEL_VERTICAL:
                capaMapa.minAncho = EditorGUILayout.IntField("Ancho mínimo", capaMapa.minAncho);
                capaMapa.maxAncho = EditorGUILayout.IntField("Ancho máximo", capaMapa.maxAncho);
                capaMapa.maxCambio = EditorGUILayout.IntField("Máximo cambio", capaMapa.maxCambio);
                capaMapa.aspereza = EditorGUILayout.IntSlider(new GUIContent("Aspereza", "Esto se compara con un número aleatorio para determinar si podemos cambiar la posición x actual de la ruta."), capaMapa.aspereza, 0, 1);
                capaMapa.movimiento = EditorGUILayout.IntSlider(new GUIContent("Movimiento", "Esto se compara con un número aleatorio para determinar si podemos cambiar el ancho del túnel."), capaMapa.movimiento, 0, 100);
                break;
            ...
            case Algoritmo.TUNEL_VERTICAL_MODIFICADO:
                ...
                capaMapa.maxAncho = EditorGUILayout.IntField("Ancho máximo", capaMapa.maxAncho);
                capaMapa.maxCambio = EditorGUILayout.IntField("Máximo cambio", capaMapa.maxCambio);
                capaMapa.aspereza = EditorGUILayout.IntSlider(new GUIContent("Aspereza", "Esto se compara con un número aleatorio para determinar si podemos cambiar la posición x actual de la ruta."), capaMapa.aspereza, 0, 100);
                capaMapa.desplazamientoMax = EditorGUILayout.IntField(new GUIContent("Desplazamiento máximo", "Esto se compara con un número aleatorio para determinar si podemos cambiar el ancho del túnel."), capaMapa.desplazamientoMax);
                capaMapa.desplazamiento = EditorGUILayout.Slider(new GUIContent("Desplazamiento", "Esto se compara con un número aleatorio para determinar si podemos cambiar el ancho del túnel."), capaMapa.desplazamiento, 0f, 1f);
                break;
